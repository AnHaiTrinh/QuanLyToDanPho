...
INSERT INTO ho_khau (maHoKhau, chuHo, diaChi, ngayLap, idNguoiThucHien) VALUES
                                                                            ('HK1', N'Trịnh Văn An', N'Số 1, Tạ Quang Bửu, Hai Bà trưng, Hà Nội', '2023-01-05', 1),
...
INSERT INTO nhan_khau (maNhanKhau, maHoKhau, hoTen, bietDanh, ngaySinh, gioiTinh, tonGiao, tinhTrang, idNguoiThucHien) VALUES
                                                                                                                           ('NK1', 'HK1', N'Trịnh Văn An', NULL, '1974-12-07', N'Nam', NULL, N'Đã xác nhận', 1),
...
INSERT INTO tam_tru (maHoKhau, CCCD, hoTen, tuNgay, denNgay, lydo, tinhTrang, idNguoiThucHien) VALUES
                                                                                                   ('HK1', '087084000999', N'Nguyễn Đức Anh', '2023-01-07', '2023-01-15', N'Lên Hà Nội chơi', N'Đã xác nhận', 5),
                                                                                                   ('HK2', '001088012345', N'Nguyễn Mỹ Linh', '2023-01-31', '2023-07-31', N'Đến ở nhờ do sửa nhà', N'Chờ xác nhận', 4);
...
INSERT INTO tam_vang (maNhanKhau, noiTamVang, tuNgay, denNgay, lydo, tinhTrang, idNguoiThucHien) VALUES
    ('NK2', N'Điện Biên', '2023-02-27', '2024-02-27', N'Đi nghĩa vụ quân sự', N'Chờ xác nhận', 2);
...
INSERT INTO dip_trao_thuong (tenDip, nam, ngayTao, ngayKetThuc, kieu) VALUES
                                                                          (N'Trung Thu', 2022, '2022-10-07', '2022-10-21', N'Dịp đặc biệt'),
...
INSERT INTO thong_tin_dip_dac_biet (maNhanKhau, idDip, tinhTrang, idNguoiThucHien) VALUES
                                                                                       ('NK8', 1, N'Đã xác nhận', 6),
