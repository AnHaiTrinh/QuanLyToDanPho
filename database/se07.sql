...
INSERT INTO tam_tru (maTamTru, CCCD, hoTen, noiTamTru, tuNgay, denNgay, lydo, tinhTrang, idNguoiThucHien) VALUES
	('TT001', '087084000999', N'Nguyễn Đức Anh', N'Số 3, Tạ Quang Bứu, Hai Bà Trưng, Hà Nội', '2023-01-07', '2023-01-15', N'Lên Hà Nội chơi', N'Đã xác nhận    ', 5),
	('TT002', '001088012345', N'Nguyễn Mỹ Linh', N'Số 2, Tạ Quang Bứu, Hai Bà Trưng, Hà Nội', '2023-01-31', '2023-07-31', N'Đến ở nhờ do sửa nhà', N'Chờ xác nhận   ', 4);
...
INSERT INTO tam_vang (maTamVang, maNhanKhau, noiTamVang, tuNgay, denNgay, lydo, tinhTrang, idNguoiThucHien) VALUES
	('TV001', 'NK2', N'Điện Biên', '2023-02-27', '2024-02-27', N'Đi nghĩa vụ quân sự', N'Chờ xác nhận   ', 2);
